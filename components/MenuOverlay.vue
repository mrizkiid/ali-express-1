<template>
    <div id="MenuOverlay" class="fixed z-50 bottom-0 h-full w-full bg-white px-3">
        <div class="flex items justify-between py-5">
            <NuxtLink 
                to="/" @click="userStore.isMenuOverlay = false"
                class="rounded-full p-1 hover:bg-gray-200"    
            >
                <img src="/AliExpress-logo.png" alt="ali-express" width="170">
            </NuxtLink>

            <button @click="userStore.isMenuOverlay = false">
        ...
        <div class="flex items-center justify-between pt-5">
            <ul class="w-full">
                ...
                >
                    <div class="flex items-center text-[20px] font-semibold">
                        <Icon name="ph:shopping-cart-light" size="33" />
                        <span class="pl-4">Cart</span>
                    </div>

                    <div class="
                        flex items-center justify-center bg-[#FF4646] h-[35px] min-w-[35px] text-lg text-white rounded-full
                    ">
